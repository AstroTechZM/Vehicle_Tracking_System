...
class DashboardImplementation extends JFrame {
    ...
    private JPanel createSummaryPanel() {
        ...
        gridPanel.add(livePanel("this is a dummy text", 50,400,100));
    ...
    private JPanel livePanel(String words, int value,int Dimension1,int Dimension2) {
        ...
        textHolder.setBackground(new Color(20, 50, 80));
        ...
        sumHolder.setBackground(new Color(20, 50, 80));
        ...
        panel.setBackground(new Color(20, 50, 80));
        text.setForeground(Color.WHITE);
        sum.setForeground(Color.WHITE);
        
        return panel;
    }
    private DefaultTableModel tableModel = new DefaultTableModel(new String[]{"Entry ID", "License Plate", "Owner Name", "Check-In Time", "Check-Out","Status"}, 0);

    private JPanel ShortCheckInOut()
    {
		JPanel tabel = new JPanel(new BorderLayout());
		...
		// Add components
		tabel.add(inputPanel, BorderLayout.NORTH);
		tabel.add(scrollPane, BorderLayout.CENTER);
		return tabel;
      }
      private JPanel regVehicleUI() {

		JPanel registrationUI = new JPanel();
        ...
        registerVehicleLabel.setForeground(new Color(20, 50, 80)); // Set text color
        ...
        RoundedButton addVehicleButton = new RoundedButton("Check In",20,new Color(20, 50, 80),new Color(59, 89, 182));
        addVehicleButton.setBounds(150, 200, 120, 30);
        //addVehicleButton.setMargin(new Insets(20, 40, 20, 40)); // Top, Left, Bottom, Right padding
        addVehicleButton.setSize(new Dimension(200,40));
        //addVehicleButton.setForeground();
